...
# Streamlit interface
st.title('Omloopplanning Validator')
...
st.subheader('Resultaten van Dienstregeling Controle')
...
if not_found_count > 0:
    ...
    st.write("Dienstritten in dienstregeling die niet in de omloopplanning zijn gevonden:")
